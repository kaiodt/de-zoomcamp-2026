...
## Prerequisites to writing a source
...
These are the available paginator types to be used in `paginator` field of `endpoint`. (Consult rest-api-pagination workflow for details).
